...
#define CLTLS_ENTITY_SIGNATURE_LENGTH ED25519_SIGNATURE_LEN
#define CLTLS_ENTITY_FULL_PUBLIC_KEY_LENGTH \
    (CLTLS_ENTITY_PUBLIC_KEY_LENGTH + CLTLS_ENTITY_SIGNATURE_LENGTH)
